...
public final class NameClientLocalProxy implements NameClientProxy{
  ...
  private static final Logger LOG = Logger.getLogger(NameClientLocalProxy.class.getName());
  ...
  @Override
  public synchronized void registerId(final Identifier id, final InetSocketAddress address) throws NetworkException {
    nameServer.register(id, address);
  }

  @Override
  public synchronized void unregisterId(final Identifier id) throws NetworkException {
  ...
  public InetSocketAddress lookup(final Identifier id) throws Exception {
    return cache.get(id, new Callable<InetSocketAddress>() {
      ...
      public InetSocketAddress call() throws Exception {
        final int origRetryCount = NameClientLocalProxy.this.retryCount;
        ...
        while (true) {
          try {
            ...
            if (retryCount <= 0) {
              ...
              final int retryTimeout = NameClientLocalProxy.this.retryTimeout
