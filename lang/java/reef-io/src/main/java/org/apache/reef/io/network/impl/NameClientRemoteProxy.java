...
public final class NameClientRemoteProxy implements NameClientProxy {
  ...
  @Override
  public void registerId(final Identifier id, final InetSocketAddress address) throws NetworkException {
    try {
  ...
  @Override
  public void unregisterId(final Identifier id) throws NetworkException {
    try {
