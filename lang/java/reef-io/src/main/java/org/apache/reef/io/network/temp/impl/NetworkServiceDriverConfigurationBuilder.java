 ...
 */
public final class NetworkServiceDriverConfigurationBuilder extends ConfigurationModuleBuilder {

  private static AtomicBoolean used = new AtomicBoolean(false);
  /**
   * The port used by name server.
   */
  private static final OptionalParameter<Integer> NAME_SERVICE_PORT = new OptionalParameter<>();


  /**
   * Identifier factory for the name service.
   */
  private static final OptionalParameter<IdentifierFactory> NAME_SERVER_IDENTIFIER_FACTORY = new OptionalParameter<>();

  /**
   * The port used by network service.
   */
  private static final OptionalParameter<Integer> NETWORK_SERVICE_PORT = new OptionalParameter<>();

  /**
   * Identifier factory for the network service.
   */
  private static final OptionalParameter<IdentifierFactory> NETWORK_SERVICE_IDENDITIFER_FACTORY = new OptionalParameter<>();

  private static final ConfigurationModule CONF = new NetworkServiceDriverConfigurationBuilder()
  ...
  @Inject
  public NetworkServiceDriverConfigurationBuilder() {
