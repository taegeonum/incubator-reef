...
import org.apache.reef.io.network.impl.NameClientLocalProxy;
...
/**
 * Configuration Module Builder for DriverSide NetworkService.
 */
public final class NetworkServiceDriverConfiguration extends ConfigurationModuleBuilder {
  ...
  public static final ConfigurationModule CONF = new NetworkServiceDriverConfiguration()
      .bindImplementation(NetworkServiceConfigurationBuilder.class, NetworkServiceConfigurationBuilderImpl.class)
