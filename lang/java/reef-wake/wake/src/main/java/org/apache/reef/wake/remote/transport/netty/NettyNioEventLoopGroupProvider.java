...
/*
 * Netty NioEventLoopGroup provider
 */
@DefaultImplementation(DefaultNettyNioEventLoopGroupProvider.class)
public interface NettyNioEventLoopGroupProvider extends AutoCloseable {
